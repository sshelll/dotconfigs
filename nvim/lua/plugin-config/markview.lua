...
require("markview").setup({
    ...
    highlight_groups = {
        ...
        MarkviewIcon0 = { fg = "#555f88", bg = "none" },
        MarkviewIcon1 = { fg = "#79a2f6", bg = "none" },
        MarkviewIcon2 = { fg = "#dfaf67", bg = "none" },
        MarkviewIcon3 = { fg = "#9dce69", bg = "none" },
        MarkviewIcon4 = { fg = "#19bc9b", bg = "none" },
